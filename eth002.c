/*
 * POSIX C example program for controlling an ETH002.
 *
 ...
 */
void printHelp(void) {
  printf("usage: eth002 [options] ip_address\n");
  printf("  options:\n");
  ...
  printf("    -t <io>   Toggle digital output <io> (1 - 2).\n");
